...
const TOOL_MATCH = {
  DOC: { primary: "claude", secondary: "chatgpt", reason: "구조화된 문서 작성과 긴 보고서에 최적화" },
  DATA: { primary: "chatgpt", secondary: "claude", reason: "Code Interpreter로 데이터 분석, 차트 생성 가능" },
  SEARCH: { primary: "perplexity", secondary: "genspark", reason: "출처 기반 실시간 검색으로 정확한 정보 제공" },
  CS: { primary: "chatgpt", secondary: "claude", reason: "다양한 톤의 응대 스크립트 및 답변 생성" },
  COORD: { primary: "gemini", secondary: "chatgpt", reason: "구글 캘린더/메일 연동으로 일정 관리 최적화" },
};
